...
@interface zcityMasterViewController () {
    NSMutableArray *_objects;
}
@end

@implementation zcityMasterViewController
...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender
{
    if ([[segue identifier] isEqualToString:@"showDetail"]) {
        ...
        zcityDetailViewController *detailController =segue.destinationViewController;
